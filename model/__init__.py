...
class TextSummarizer:
    ...
    from ._train_utils import fit, get_batch
    from ._backup_utils import save_model, load_model

    def __init__(self, Tx, Ty, batch_size, vocab_size, embedding_dim, a_units, h_units, word_dict, index_dict, max_global_oov, save_dir_path="", pointer_extract=True, sp_mode=False):
        # hyperparameters
    ...
    def indeces_to_words(self, indeces, oov_vocab, remove_paddings=False, model_file=""):
        transcript = ""
        if self.sp_mode: 
